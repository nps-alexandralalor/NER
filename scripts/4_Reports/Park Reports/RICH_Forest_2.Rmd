...
1.  The fuel model most representative of this vegetation association is TL6 [@scott_standard_2005]. "Timber Litter" (TL) fuel models are primarily driven by dead and down woody fuel, and TL6 specifically represents moderate load broadleaf litter. To moderate fire spread potential, fine fuel loading should be at or below what is expected for each fuel model.
2.  To promote oak and pine regeneration, duff depth should be maintained at 1.5 inches or below [@jenkins_yellow_2011].
3.  Advanced regeneration potential can be indicated by competitive seedlings. The size class of seedlings most likely to survive are those which are \>1m in height (referred to here as "saplings").
4.  Pole-sized trees are classified as between 2.5cm and 15cm diameter measured at a height of 1.3m (DBH). Species composition of pole-sized trees reflect the trajectory of forest change and can be targeted for thinning treatments. Fire-adapted oak-pine ecosystems contain a higher ratio of xeric species, which are drought tolerant and usually fire-adapted, compared to mesic species, which are tolerant of shadier and moister conditions [@alexander_mesophication_2021].
5.  Overstory trees are classifed as \>15cm DBH. These are the mature trees which make up the overall forest structure. Oaks need abundant light and sun to have successful regeneration. To maintain open canopy woodlands, tree stocking density should be maintained within 30-70% [@ginrich_measuring_1967; @kabrick_silvicultural_2014]
