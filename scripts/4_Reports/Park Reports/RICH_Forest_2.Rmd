...
Objectives <- data.frame(
  Objective = c(
    "1. Maintain fine fuel loading (litter, 1-hr, 10-hr, and 100-hr fuels) to < 3.4 tons/acre (Scott & Burgan 2006, Fuel Model TL6) in order to moderate fire spread potential",
    "2. Maintain duff depth to <= 1 inch in order to promote oak regeneration potential",
    "3. Achieve open woodland forest structure by maintating a stocking density of overstory trees (>15cm DBH) of between 30-70%",
    "4. Maintain 70:30 ratio of xeric:mesic pole-sized (2.5-15cm DBH) tree density to encourage dominance of fire adapted tree species",
    "5. >75% increase in native grasses and forbs"
    ))
...
target_new_FineFuelLoading <- 2.4
target_new_PoleDensity <- 380 * .5
target_new_Cover <- 2.4 * 1.75
```

### Resources

Current Vegetation Association:

-   Northeastern Coastal Plain Mixed Oak / Heath Forest ; Quercus alba - Quercus falcata - (Carya pallida) / Gaylussacia frondosa Forest [(CEGL006269)](https://explorer.natureserve.org/Taxon/ELEMENT_GLOBAL.2.689304/Quercus_alba_-_Quercus_falcata_-_(Carya_pallida)_-_Gaylussacia_frondosa_Forest)

Desired Future Condition ?

Fuel Types (Scott and Burgan 2006 Standard Fire Behavior Fuel Models):

-   TL6 (fine fuel load = 2.4 tons/acre)

-   TU3 (fine fuel load = 2.85 tons/acre)

-   SH4 (fine fuel load = 3.4 tons/acre)
