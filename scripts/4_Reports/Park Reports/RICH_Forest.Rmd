...
Objectives <- data.frame(
  Objective = c(
    ...
    "",
    "FMP 1. Reduce the loading of 1-hr and 10-hr fuels by >50% and >25%, repsectively",
    "FMP 2. Reduce the loading of 100-hr and 1000-hr fuels by >50% and >25, respectively"
    ))
...
-   GR1 (fine fuel load = 0.40 tons/acre)
