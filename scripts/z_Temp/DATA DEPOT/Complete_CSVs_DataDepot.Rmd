...
# adjust file paths
path_main <- "E:/Allie/FireFX_NER/FFI_DATA_MANAGEMENT/Exports_Clean/"
#path_main <- "C:/Users/alalor/OneDrive - DOI/NER/FireFX/FFI Data Management/Exports_Clean/"
path_data_DD <- paste0(path_main, "DataDepot/")
path_data_FFI <- paste0(path_main, "FFI/")
```
...
# # project unit report
ProjectUnitReport <- read_csv(paste0(path_data_DD, "all_project_units.csv"))

# protocols
Fuels1000_O <- read_csv(paste0(path_data_FFI, "english_surface_fuels_thousand_hr.csv"))
FuelsDuffLitt_O <- read_csv(paste0(path_data_FFI, "english_surface_fuels_duff_litter.csv"))
FuelsFine_O <- read_csv(paste0(path_data_FFI, "english_surface_fuels_fine.csv"))
Trees_O <- read_csv(paste0(path_data_FFI, "metric_trees_individuals.csv"))
HerbsSpComp_O <- read_csv(paste0(path_data_FFI, "metric_cover_species_composition.csv"))
HerbsPoints_O <- read_csv(paste0(path_data_FFI, "metric_cover_points.csv"))

# protocols
Fuels1000_E <- read_csv(paste0(path_data_DD, "english_surface_fuels_thousand_hr.csv"))
FuelsDuffLitt_E <- read_csv(paste0(path_data_DD, "english_surface_fuels_duff_litter.csv"))
FuelsFine_E <- read_csv(paste0(path_data_DD, "english_surface_fuels_fine.csv"))
Trees_E <- read_csv(paste0(path_data_DD, "english_trees_individuals.csv"))
HerbsSpComp_E <- read_csv(paste0(path_data_DD, "english_cover_species_composition.csv"))
HerbsPoints_E <- read_csv(paste0(path_data_DD, "english_cover_points.csv"))

# protocols
Fuels1000_M <- read_csv(paste0(path_data_DD, "metric_surface_fuels_thousand_hr.csv"))
FuelsDuffLitt_M <- read_csv(paste0(path_data_DD, "metric_surface_fuels_duff_litter.csv"))
FuelsFine_M <- read_csv(paste0(path_data_DD, "metric_surface_fuels_fine.csv"))
Trees_M <- read_csv(paste0(path_data_DD, "metric_trees_individuals.csv"))
HerbsSpComp_M <- read_csv(paste0(path_data_DD, "metric_cover_species_composition.csv"))
HerbsPoints_M <- read_csv(paste0(path_data_DD, "metric_cover_points.csv"))
...
# blank protocols
# FuelsDuffLittAK_E <- read_csv(paste0(path_data_english, "data_surface_fuels_alaska_duff_litter.csv"))
# FuelsPiles_E <- read_csv(paste0(path_data_english, "data_surface_fuels_piles.csv"))
# FuelsVeg_E <- read_csv(paste0(path_data_english, "data_surface_fuels_vegetation.csv"))
# TreesSaplings_E <- read_csv(paste0(path_data_english, "data_trees_saplings.csv"))
# TreesSeedlings_E <- read_csv(paste0(path_data_english, "data_trees_seedlings.csv"))
#HerbsFrequency_E <- read_csv(paste0(path_data_english, "ffi_", target_park, "_data_export_cover_frequency.csv"))
# blank protocols
# FuelsDuffLittAK_M <- read_csv(paste0(path_data_metric, "data_surface_fuels_alaska_duff_litter.csv"))
# FuelsPiles_M <- read_csv(paste0(path_data_metric, "data_surface_fuels_piles.csv"))
# FuelsVeg_M <- read_csv(paste0(path_data_metric, "data_surface_fuels_vegetation.csv"))
# TreesSaplings_M <- read_csv(paste0(path_data_metric, "data_trees_saplings.csv"))
# TreesSeedlings_M <- read_csv(paste0(path_data_metric, "data_trees_seedlings.csv"))
...
```{r}
# Clean up data frame
df_names <- c("ProjectUnitReport", 
              "Fuels1000_O", "Fuels1000_E", "Fuels1000_M",
              "FuelsDuffLitt_O", "FuelsDuffLitt_E", "FuelsDuffLitt_M",
              "FuelsFine_O", "FuelsFine_E", "FuelsFine_M",
              "Trees_O", "Trees_E", "Trees_M",
              "HerbsSpComp_O","HerbsSpComp_E", "HerbsSpComp_M",
              "HerbsPoints_O","HerbsPoints_E", "HerbsPoints_M"
              )
...
Fuels1000_DataDepot <- Fuels1000_E %>% 
  mutate(
    ...
    Macroplot_UV3 = as.character(Macroplot_UV3)
    ) %>% 
  select(!c(OrganizationId, AdminUnitId, MacroplotId, SampleEventId, MethodId, MethodData_Id, MethodDataId, Organization_Name, AdminUnit_Comment, Macroplot_Lat_dd, Macroplot_Long_dd, Macroplot_UtmX_m, Macroplot_UtmY_m, Macroplot_UtmZone, Macroplot_Datum, Macroplot_Pdop, Macroplot_Precision, Macroplot_DateIn, Macroplot_DateOut, Macroplot_FutureVisit, Macroplot_Elevation, Macroplot_ElevationUnits, Macroplot_Azimuth, Macroplot_Aspect, Macroplot_SlopeHill_pct, Macroplot_SlopeTransect_pct, Macroplot_LocatedBy, Macroplot_StartPoint, Macroplot_Directions, Macroplot_Comment, Macroplot_Metadata, SampleEvent_Who, SampleEvent_Comment, SampleEvent_UserVariables, SampleEvent_LegacyMonitoringStatus, SampleData_Executed, MethodData_CreatedDate, MethodData_UpdatedDate, MethodData_DeletedDate)) %>% 
  relocate(Macroplot_Name, .after = Macroplot_UV8) %>%
  relocate(SampleEvent_TreatmentUnit, .before = SampleEvent_Date) %>% 
  relocate(MethodData_Visited, .after = MethodData_SAComment) %>% 
...
```{r}
# known differences
Fuels1000_DataDepot_SHEN <- Fuels1000_DataDepot %>% 
  filter(
    !SampleEvent_TreatmentUnit %in% c("Pumpkin Hill Unit A", "Pumpkin Hill"),
    !Macroplot_UV1 %in% c("Hemlock"),
    !(Macroplot_Name == "Pine Oak 07" & SampleEvent_Date == as.Date("2021-05-26")),
    !(Macroplot_Name == "Pine Oak 08" & SampleEvent_Date == as.Date("2021-06-07")),
    !(Macroplot_Name == "Pine Oak 10" & SampleEvent_Date == as.Date("2021-06-21")),
    !(Macroplot_Name == "Xer Oak 04" & SampleEvent_Date == as.Date("2021-05-27")),
    !(Macroplot_Name == "Xer Oak 05" & SampleEvent_Date == as.Date("2021-06-16")),
    !(Macroplot_Name == "Xer Oak 07" & SampleEvent_Date == as.Date("2021-06-24")),
    !(Macroplot_Name == "Xer Oak 08" & SampleEvent_Date == as.Date("2021-06-17"))
    )
```

```{r}
# known differences
Fuels1000_DataDepot_NERI <- Fuels1000_DataDepot %>% 
  filter(
    !(Macroplot_Name == "Plot 03" & SampleEvent_Date == as.Date("2025-06-03") & MethodData_LogNum == 5)
    )
```

```{r}
diffdf(Fuels1000_DataDepot_NERI, Fuels1000_DataFFI)
```
...
```{r}
# known differences
FuelsDuffLitt_DataDepot_SHEN <- FuelsDuffLitt_DataDepot %>% 
  filter(
    !SampleEvent_TreatmentUnit %in% c("Pumpkin Hill Unit A", "Pumpkin Hill"),
    !Macroplot_UV1 %in% c("Hemlock"),
    !(Macroplot_Name == "Pine Oak 07" & SampleEvent_Date == as.Date("2021-05-26")),
...
```{r}
diffdf(FuelsDuffLitt_DataDepot_SHEN, FuelsDuffLitt_DataFFI)
```
...
```{r}
# known differences
FuelsFine_DataDepot_SHEN <- FuelsFine_DataDepot %>% 
  filter(
    !SampleEvent_TreatmentUnit %in% c("Pumpkin Hill Unit A", "Pumpkin Hill"),
    !Macroplot_UV1 %in% c("Hemlock"),
    !(Macroplot_Name == "Pine Oak 07" & SampleEvent_Date == as.Date("2021-05-26")),
...
```{r}
diffdf(FuelsFine_DataDepot_SHEN, FuelsFine_DataFFI)
```
...
Trees_DataDepot <- Trees_M %>% 
  mutate(SampleEvent_Date = as.Date(SampleEvent_Date, "%m/%d/%Y")) %>% 
  select(!c(
    OrganizationId, AdminUnitId, MacroplotId, SampleEventId, MethodId, MethodData_Id, MethodDataId, Organization_Name, AdminUnit_Comment, Macroplot_Lat_dd, Macroplot_Long_dd, Macroplot_UtmX_m, Macroplot_UtmY_m, Macroplot_UtmZone, Macroplot_Datum, Macroplot_Pdop, Macroplot_Precision, Macroplot_DateIn, Macroplot_DateOut, Macroplot_FutureVisit, Macroplot_Elevation, Macroplot_ElevationUnits, Macroplot_Azimuth, Macroplot_Aspect, Macroplot_SlopeHill_pct, Macroplot_SlopeTransect_pct, Macroplot_LocatedBy, Macroplot_StartPoint, Macroplot_Directions, Macroplot_Comment, Macroplot_Metadata, SampleEvent_Who, SampleEvent_Comment, SampleEvent_UserVariables, SampleEvent_LegacyMonitoringStatus, SampleData_Executed, MethodData_CreatedDate, MethodData_UpdatedDate, MethodData_DeletedDate, MethodData_SppGuid, MethodData_Density, MethodData_BasalArea,
    Species_SourceEntityId, Species_LocalSpeciesId, Species_MasterSpeciesId, Species_AuxSpeciesId, Species_ITISTaxonomicSerialNumber, Species_SymbolLocal, Species_SymbolMaster, Species_CommonNameLocal, Species_CommonName, Species_Nativity, Species_LifeFormName, Species_Description, Species_LifeCycle, Species_Cultural, Species_Concern, Species_Retired, Species_Comment, Species_UV1, Species_UV2, Species_UV3,
    Species_Family, Species_Genus, Species_ScientificName, Species_LifeCycleLocal, Species_LifeFormNameLocal, Species_NativityLocal, Species_Invasive, Species_NotBiological
    )) %>% 
  relocate(Macroplot_Name, .after = Macroplot_UV8) %>%
  relocate(SampleEvent_TreatmentUnit, .before = SampleEvent_Date) %>% 
  relocate(MethodData_Visited, .after = MethodData_SAComment) %>% 
  arrange(Macroplot_Name, SampleEvent_Date, MethodData_Index, MethodData_SubFrac, MethodData_QTR, MethodData_TagNo)

Trees_DataFFI <- Trees_O %>% 
  mutate(SampleEvent_Date = as.Date(SampleEvent_Date, "%m/%d/%Y")) %>% 
  select(!c(
    MonitoringStatus_Name, MonitoringStatus_Prefix, MonitoringStatus_Base, MonitoringStatus_Suffix, MonitoringStatus_Order,
    Species_Family, Species_Genus, Species_ScientificName, Species_LifeCycleLocal, Species_LifeFormNameLocal, Species_NativityLocal, Species_Invasive, Species_NotBiological)) %>% 
  arrange(Macroplot_Name, SampleEvent_Date, MethodData_Index, MethodData_SubFrac, MethodData_QTR, MethodData_TagNo)
```
...
```{r}
# known differences
Trees_DataDepot_SHEN <- Trees_DataDepot %>%
  filter(
    !(Macroplot_Name == "Pine Oak 10" & SampleEvent_Date == as.Date("2021-06-21")),
    !(Macroplot_Name == "Pine Oak 11" & SampleEvent_Date == as.Date("2022-08-04")),
    !(Macroplot_Name == "Xer Oak 07" & SampleEvent_Date == as.Date("2021-06-24")),
    !(Macroplot_Name == "Pine Oak 09" & SampleEvent_Date == as.Date("2022-08-02") & MethodData_TagNo == "2504"),
    !(Macroplot_Name == "Pine Oak 09" & SampleEvent_Date == as.Date("2022-08-02") & MethodData_TagNo == "2531"),
    !(Macroplot_Name == "Pine Oak 09" & SampleEvent_Date == as.Date("2022-08-02") & MethodData_TagNo == "2547")
    )
```

```{r}
diffdf(Trees_DataDepot_SHEN, Trees_DataFFI)
```
...
HerbsSpComp_DataDepot <- HerbsSpComp_M %>% 
  mutate(SampleEvent_Date = as.Date(SampleEvent_Date, "%m/%d/%Y")) %>% 
  select(!c(
    OrganizationId, AdminUnitId, MacroplotId, SampleEventId, MethodId, MethodData_Id, MethodDataId, Organization_Name, AdminUnit_Comment, Macroplot_Lat_dd, Macroplot_Long_dd, Macroplot_UtmX_m, Macroplot_UtmY_m, Macroplot_UtmZone, Macroplot_Datum, Macroplot_Pdop, Macroplot_Precision, Macroplot_DateIn, Macroplot_DateOut, Macroplot_FutureVisit, Macroplot_Elevation, Macroplot_ElevationUnits, Macroplot_Azimuth, Macroplot_Aspect, Macroplot_SlopeHill_pct, Macroplot_SlopeTransect_pct, Macroplot_LocatedBy, Macroplot_StartPoint, Macroplot_Directions, Macroplot_Comment, Macroplot_Metadata, SampleEvent_Who, SampleEvent_Comment, SampleEvent_UserVariables, SampleEvent_LegacyMonitoringStatus, SampleData_Executed, MethodData_CreatedDate, MethodData_UpdatedDate, MethodData_DeletedDate, MethodData_SppGuid, MethodData_SpeciesId,
    Species_SourceEntityId, Species_LocalSpeciesId, Species_MasterSpeciesId, Species_AuxSpeciesId, Species_ITISTaxonomicSerialNumber, Species_SymbolLocal, Species_SymbolMaster, Species_CommonNameLocal, Species_CommonName, Species_Nativity, Species_LifeFormName, Species_Description, Species_LifeCycle, Species_Cultural, Species_Concern, Species_Retired, Species_Comment, Species_UV1, Species_UV2, Species_UV3
    )) %>% 
  relocate(Macroplot_Name, .after = Macroplot_UV8) %>%
  relocate(SampleEvent_TreatmentUnit, .before = SampleEvent_Date) %>% 
...
```{r}
# known differences
HerbsSpComp_DataDepot_SHEN <- HerbsSpComp_DataDepot %>%
  filter(
    !(Macroplot_Name == "Pine Oak 10" & SampleEvent_Date == as.Date("2021-06-21")),
    !(Macroplot_Name == "Xer Oak 07" & SampleEvent_Date == as.Date("2021-06-24")),
    )

HerbsSpComp_DataFFI_SHEN <- HerbsSpComp_DataFFI %>%
  filter(
    !(Macroplot_Name == "Pine Oak 01" & SampleEvent_Date == as.Date("2009-09-03")),
    !(Macroplot_Name == "Pine Oak 03" & SampleEvent_Date == as.Date("2009-09-02")),
    !(Macroplot_Name == "Gray Birch Plot 01" & SampleEvent_Date == as.Date("2001-07-02")),
    !(Macroplot_Name == "Gray Birch Plot 02" & SampleEvent_Date == as.Date("2001-08-01")),
    !(Macroplot_Name == "Gray Birch Plot 09" & SampleEvent_Date == as.Date("2003-06-12"))
    )
```

```{r}
# known differences
HerbsSpComp_DataDepot_NERI <- HerbsSpComp_DataDepot %>%
  filter(
    !(Macroplot_Name == "Plot 03" & SampleEvent_Date == as.Date("2022-09-01")),
    !(Macroplot_Name == "Plot 03" & SampleEvent_Date == as.Date("2024-07-30")),
    !(Macroplot_Name == "Plot 03" & SampleEvent_Date == as.Date("2025-06-03")),
    
    !(Macroplot_Name == "Plot 04" & SampleEvent_Date == as.Date("2022-09-01")),
    !(Macroplot_Name == "Plot 04" & SampleEvent_Date == as.Date("2024-07-31")),
    !(Macroplot_Name == "Plot 04" & SampleEvent_Date == as.Date("2025-06-04"))
    )
```

```{r}
# known differences
HerbsSpComp_DataDepot_RICH <- HerbsSpComp_DataDepot %>%
  filter(
    !(Macroplot_Name == "Plot 01 Cold Harbor" & SampleEvent_Date == as.Date("2024-09-25") & MethodData_RemoteApp_LocalSpeciesSymbol == "LESPRO"),
    !(Macroplot_Name == "Plot 01 Cold Harbor" & SampleEvent_Date == as.Date("2024-09-25") & is.na(MethodData_EntryTeam)),
    !(Macroplot_Name == "Plot 07 Malvern Hill" & SampleEvent_Date == as.Date("2025-08-05") & MethodData_RemoteApp_LocalSpeciesSymbol == "MUHSPP"),
    !(Macroplot_Name == "Plot 07 Malvern Hill" & SampleEvent_Date == as.Date("2025-08-05") & is.na(MethodData_EntryTeam)),
    !(Macroplot_Name == "Plot 08 Malvern Hill" & SampleEvent_Date == as.Date("2025-08-05") & MethodData_Index == "-2147483635"),
    !(Macroplot_Name == "Plot 11 Malvern Hill" & SampleEvent_Date == as.Date("2025-08-13") & MethodData_Index == "-2147483636")
    )
```

```{r}
# known differences
HerbsSpComp_DataDepot_SARA <- HerbsSpComp_DataDepot %>%
  filter(
    !(Macroplot_Name == "Plot 01"),
    !(Macroplot_Name == "Plot 04"),
    !(Macroplot_Name == "Plot 08"),
    !(Macroplot_Name == "Plot 10"),
    !(Macroplot_Name == "Plot 13"),
    !(Macroplot_Name == "Plot 16"),
    !(Macroplot_Name == "Plot 19"),
    !(Macroplot_Name == "Plot 21"),
    !(Macroplot_Name == "Plot 22")
    )
```

```{r}
# known differences
HerbsSpComp_DataDepot_MONO <- HerbsSpComp_DataDepot %>%
  filter(
    !(Macroplot_Name == "Plot 01" & SampleEvent_Date == as.Date("2024-10-29")),
    !(Macroplot_Name == "Plot 02" & SampleEvent_Date == as.Date("2024-10-30")),
    !(Macroplot_Name == "Plot 04" & SampleEvent_Date == as.Date("2024-10-30") & MethodData_Index == "-2147483627")
  )
```

```{r}
diffdf(HerbsSpComp_DataDepot_MONO, HerbsSpComp_DataFFI)
```
...
HerbsPoints_DataDepot <- HerbsPoints_M %>% 
  mutate(SampleEvent_Date = as.Date(SampleEvent_Date, "%m/%d/%Y")) %>% 
  select(!c(
    OrganizationId, AdminUnitId, MacroplotId, SampleEventId, MethodId, MethodData_Id, MethodDataId, Organization_Name, AdminUnit_Comment, Macroplot_Lat_dd, Macroplot_Long_dd, Macroplot_UtmX_m, Macroplot_UtmY_m, Macroplot_UtmZone, Macroplot_Datum, Macroplot_Pdop, Macroplot_Precision, Macroplot_DateIn, Macroplot_DateOut, Macroplot_FutureVisit, Macroplot_Elevation, Macroplot_ElevationUnits, Macroplot_Azimuth, Macroplot_Aspect, Macroplot_SlopeHill_pct, Macroplot_SlopeTransect_pct, Macroplot_LocatedBy, Macroplot_StartPoint, Macroplot_Directions, Macroplot_Comment, Macroplot_Metadata, SampleEvent_Who, SampleEvent_Comment, SampleEvent_UserVariables, SampleEvent_LegacyMonitoringStatus, SampleData_Executed, MethodData_CreatedDate, MethodData_UpdatedDate, MethodData_DeletedDate, MethodData_SppGuid, MethodData_RemoteApp_LocalSpeciesSymbol, MethodData_SpeciesId,
    Species_SourceEntityId, Species_LocalSpeciesId, Species_MasterSpeciesId, Species_AuxSpeciesId, Species_ITISTaxonomicSerialNumber, Species_SymbolLocal, Species_SymbolMaster, Species_CommonNameLocal, Species_CommonName, Species_Nativity, Species_LifeFormName, Species_Description, Species_LifeCycle, Species_Cultural, Species_Concern, Species_Retired, Species_Comment, Species_UV1, Species_UV2, Species_UV3
    )) %>% 
  relocate(Macroplot_Name, .after = Macroplot_UV8) %>%
  relocate(SampleEvent_TreatmentUnit, .before = SampleEvent_Date) %>% 
...
```{r}
# known differences
HerbsPoints_DataDepot_SHEN <- HerbsPoints_DataDepot %>%
  filter(
    !(Macroplot_Name == "Pine Oak 10" & SampleEvent_Date == as.Date("2021-06-21")),
    !(Macroplot_Name == "Xer Oak 07" & SampleEvent_Date == as.Date("2021-06-24")),
    )
...
```{r}
# known differences
HerbsPoints_DataDepot_RICH <- HerbsPoints_DataDepot %>%
  filter(
    !(Macroplot_Name == "Plot 01 Cold Harbor" & SampleEvent_Date == as.Date("2025-07-09") & MethodData_Index == "-2147483590"),
    !(Macroplot_Name == "Plot 02 Cold Harbor" & SampleEvent_Date == as.Date("2022-06-01") & MethodData_Index == "-2147483442"),
    !(Macroplot_Name == "Plot 02 Cold Harbor" & SampleEvent_Date == as.Date("2022-06-01") & is.na(Species_NotBiological)),
    !(Macroplot_Name == "Plot 04 Malvern Hill" & SampleEvent_Date == as.Date("2025-08-14") & MethodData_Index == "-2147483542"),
    !(Macroplot_Name == "Plot 05 Malvern Hill" & SampleEvent_Date == as.Date("2022-07-18") & MethodData_Index == "-2147483547"),
    !(Macroplot_Name == "Plot 05 Malvern Hill" & SampleEvent_Date == as.Date("2025-08-14") & MethodData_Index == "-2147483635"),
    !(Macroplot_Name == "Plot 06 Malvern Hill" & SampleEvent_Date == as.Date("2025-08-04") & MethodData_Index == "-2147483420"),
    !(Macroplot_Name == "Plot 06 Malvern Hill" & SampleEvent_Date == as.Date("2025-08-04") & MethodData_Index == "-2147483419"),
    !(Macroplot_Name == "Plot 06 Malvern Hill" & SampleEvent_Date == as.Date("2025-08-04") & MethodData_Index == "-2147483418"),
    !(Macroplot_Name == "Plot 07 Malvern Hill" & SampleEvent_Date == as.Date("2025-08-05") & MethodData_Index == "-2147483620"),
    !(Macroplot_Name == "Plot 07 Malvern Hill" & SampleEvent_Date == as.Date("2025-08-05") & MethodData_Index == "-2147483468"),
    !(Macroplot_Name == "Plot 07 Malvern Hill" & SampleEvent_Date == as.Date("2025-08-05") & MethodData_Index == "-2147483266"),
    !(Macroplot_Name == "Plot 09 Malvern Hill" & SampleEvent_Date == as.Date("2025-07-09") & MethodData_Index == "-2147483510"),
    !(Macroplot_Name == "Plot 09 Malvern Hill" & SampleEvent_Date == as.Date("2025-07-09") & MethodData_Index == "-2147483509"),
    !(Macroplot_Name == "Plot 09 Malvern Hill" & SampleEvent_Date == as.Date("2025-07-09") & MethodData_Index == "-2147483508"),
    !(Macroplot_Name == "Plot 11 Malvern Hill" & SampleEvent_Date == as.Date("2025-08-13") & MethodData_Index == "-2147483406")
    )
```

```{r}
# known differences
HerbsPoints_DataDepot_SARA <- HerbsPoints_DataDepot %>%
  filter(
    !(Macroplot_Name == "Plot 01"),
    !(Macroplot_Name == "Plot 04"),
    !(Macroplot_Name == "Plot 08"),
    ...
    !(Macroplot_Name == "Plot 21"),
    !(Macroplot_Name == "Plot 22"),
    !(Macroplot_Name == "Plot 14" & SampleEvent_Date == as.Date("2022-07-11") & MethodData_Index == "-2147483332"),
    !(Macroplot_Name == "Plot 14" & SampleEvent_Date == as.Date("2022-07-11") & MethodData_Index == "-2147483331"),
    !(Macroplot_Name == "Plot 14" & SampleEvent_Date == as.Date("2022-07-11") & MethodData_Index == "-2147483330"),
    !(Macroplot_Name == "Plot 14" & SampleEvent_Date == as.Date("2022-07-11") & MethodData_Index == "-2147483329"),
    !(Macroplot_Name == "Plot 14" & SampleEvent_Date == as.Date("2022-07-11") & MethodData_Index == "-2147483328"),
    !(Macroplot_Name == "Plot 14" & SampleEvent_Date == as.Date("2022-07-11") & MethodData_Index == "-2147483327"),
    !(Macroplot_Name == "Plot 24" & SampleEvent_Date == as.Date("2022-06-01") & MethodData_Index == "-2147483314")
    )
```

```{r}
# known differences
HerbsPoints_DataDepot_MONO <- HerbsPoints_DataDepot %>%
  filter(
    !(Macroplot_Name == "Plot 01" & SampleEvent_Date == as.Date("2024-10-29") & MethodData_Index == "-2147483333")
  )

```

```{r}
diffdf(HerbsPoints_DataDepot_MONO, HerbsPoints_DataFFI)
```
