...
path_main <- "C:/Users/alalor/OneDrive - DOI/NER/FireFX/FFI Data Management/R Outputs Data Depot/"
...
# # project unit report
ProjectUnitReport_E <- read_csv(paste0(path_data_english, "project_units.csv"))
ProjectUnitReport_M <- read_csv(paste0(path_data_metric, "project_units.csv"))
...
# protocols
Fuels1000_E <- read_csv(paste0(path_data_english, "data_surface_fuels_thousand_hr.csv"))
FuelsDuffLitt_E <- read_csv(paste0(path_data_english, "data_surface_fuels_duff_litter.csv"))
FuelsFine_E <- read_csv(paste0(path_data_english, "data_surface_fuels_fine.csv"))
Trees_E <- read_csv(paste0(path_data_english, "data_trees_individuals.csv"))
HerbsSpComp_E <- read_csv(paste0(path_data_english, "data_cover_species_composition.csv"))
HerbsPoints_E <- read_csv(paste0(path_data_english, "data_cover_points.csv"))
# protocols
Fuels1000_M <- read_csv(paste0(path_data_metric, "data_surface_fuels_thousand_hr.csv"))
FuelsDuffLitt_M <- read_csv(paste0(path_data_metric, "data_surface_fuels_duff_litter.csv"))
FuelsFine_M <- read_csv(paste0(path_data_metric, "data_surface_fuels_fine.csv"))
Trees_M <- read_csv(paste0(path_data_metric, "data_trees_individuals.csv"))
HerbsSpComp_M <- read_csv(paste0(path_data_metric, "data_cover_species_composition.csv"))
HerbsPoints_M <- read_csv(paste0(path_data_metric, "data_cover_points.csv"))
