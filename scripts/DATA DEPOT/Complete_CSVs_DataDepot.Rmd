...
# path_data_english <- paste0(path_main, "Data Depot/English/")
# path_data_metric <- paste0(path_main, "Data Depot/Metric/")
# path_data_original <- paste0(path_main, "FFI/")
```
...
Fuels1000_DataDepot_SHEN <- Fuels1000_DataDepot %>% 
  filter(
    ...
    !(Macroplot_Name == "Pine Oak 07" & SampleEvent_Date == "05/26/2021"),
    !(Macroplot_Name == "Pine Oak 08" & SampleEvent_Date == "06/07/2021"),
    !(Macroplot_Name == "Pine Oak 10" & SampleEvent_Date == "06/21/2021"),
    !(Macroplot_Name == "Xer Oak 04" & SampleEvent_Date == "05/27/2021"),
    !(Macroplot_Name == "Xer Oak 05" & SampleEvent_Date == "06/16/2021"),
    !(Macroplot_Name == "Xer Oak 07" & SampleEvent_Date == "06/24/2021"),
    !(Macroplot_Name == "Xer Oak 08" & SampleEvent_Date == "06/17/2021")
    )
```
...
Trees_DataFFI <- Trees_DataFFI %>% 
  ...
  select(!c(Macroplot_Purpose,Macroplot_Type,Macroplot_UV1,Macroplot_UV2,Macroplot_UV3,Macroplot_UV4,Macroplot_UV5,Macroplot_UV6,Macroplot_UV7,Macroplot_UV8,SampleEvent_TreatmentUnit)) %>% 
  relocate(MethodData_symbolLocal, .after = "MethodData_tagNo (num.)")
```
...
```{r}
# Trees_DataDepot_test <- Trees_DataDepot %>%
#   select(!c(MethodData_visited, `MethodData_macroPlotSize (ha)`, `MethodData_snagPlotSize (ha)`, MethodData_breakPntDia, MethodData_uV1Desc, MethodData_uV2Desc, MethodData_uV3Desc, MethodData_saComment, MethodData_index, MethodData_isVerified))
# 
# Trees_DataFFI_test <- Trees_DataFFI %>%
#   select(!c(MethodData_visited, `MethodData_macroPlotSize (ha)`, `MethodData_snagPlotSize (ha)`, MethodData_breakPntDia, MethodData_uV1Desc, MethodData_uV2Desc, MethodData_uV3Desc, MethodData_saComment, MethodData_index, MethodData_isVerified))
```
...
HerbsSpComp_DataFFI <- HerbsSpComp_DataFFI %>% 
  ...
  select(!c("Species_LifeCycleLocal","Species_NotBiological","Species_LifeFormNameLocal","Species_Family","Species_Genus","Species_ScientificName","Species_NativityLocal","Species_Invasive")) %>% 
  select(!c(Macroplot_Purpose,Macroplot_Type,Macroplot_UV1,Macroplot_UV2,Macroplot_UV3,Macroplot_UV4,Macroplot_UV5,Macroplot_UV6,Macroplot_UV7,Macroplot_UV8,SampleEvent_TreatmentUnit)) %>% 
  relocate(MethodData_symbolLocal, .before = "MethodData_status (num.)")
```
...
```{r}
HerbsSpComp_DataDepot_test <- HerbsSpComp_DataDepot %>%
  select(!c(MethodData_visited, `MethodData_minCovLevel (%)`, `MethodData_area (ha)`, MethodData_uV1Desc, MethodData_uV2Desc, MethodData_uV3Desc, MethodData_saComment, MethodData_index))

HerbsSpComp_DataFFI_test <- HerbsSpComp_DataFFI %>%
  select(!c(MethodData_visited, `MethodData_minCovLevel (%)`, `MethodData_area (ha)`, MethodData_uV1Desc, MethodData_uV2Desc, MethodData_uV3Desc, MethodData_saComment, MethodData_index))
```
...
HerbsPoints_DataFFI <- HerbsPoints_DataFFI %>% 
  ...
  select(!c("Species_LifeCycleLocal","Species_NotBiological","Species_LifeFormNameLocal","Species_Family","Species_Genus","Species_ScientificName","Species_NativityLocal","Species_Invasive")) %>% 
  select(!c(Macroplot_Purpose,Macroplot_Type,Macroplot_UV1,Macroplot_UV2,Macroplot_UV3,Macroplot_UV4,Macroplot_UV5,Macroplot_UV6,Macroplot_UV7,Macroplot_UV8,SampleEvent_TreatmentUnit)) %>% 
  relocate(MethodData_symbolLocal, .after = "MethodData_height (m)")
```
...
```{r}
HerbsPoints_DataDepot_test <- HerbsPoints_DataDepot %>%
  select(!c(MethodData_visited, `MethodData_numTran (num.)`, `MethodData_tranLen (m)`, `MethodData_numPtsTran (num.)`,`MethodData_offset (m)`, MethodData_uV1Desc, MethodData_uV2Desc, MethodData_uV3Desc, MethodData_saComment, MethodData_index, `MethodData_tape (num.)`)) %>%
  filter(!(is.na(MethodData_symbolLocal))) %>% 
  arrange(SampleEvent_Date)

HerbsPoints_DataFFI_test <- HerbsPoints_DataFFI %>%
  select(!c(MethodData_visited, `MethodData_numTran (num.)`, `MethodData_tranLen (m)`, `MethodData_numPtsTran (num.)`,`MethodData_offset (m)`, MethodData_uV1Desc, MethodData_uV2Desc, MethodData_uV3Desc, MethodData_saComment, MethodData_index, `MethodData_tape (num.)`)) %>% 
  arrange(SampleEvent_Date)
```
