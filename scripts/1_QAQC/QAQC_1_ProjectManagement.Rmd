...
qaqc_meta <- function(data, query, query_message, values_check) {
  ...
  suppressMessages(errors_temp <- errors %>% 
...
# Identify errors
errors_MacroplotReport_Quotes <- qaqc_meta(data, query, query_message, values_check)
```
...
# Identify errors
errors_ProjectUnitReport_Quotes <- qaqc_meta(data, query, query_message, values_check)
```
...
# Identify errors
errors_SampleEventReport_Quotes <- qaqc_meta(data, query, query_message, values_check)
```
