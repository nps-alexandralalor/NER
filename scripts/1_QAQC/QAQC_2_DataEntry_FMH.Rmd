...
# Identify errors
errors_HerbsSpComp_Complete <- qaqc(data, query, query_message, values_check)
```
...
condformat2excel(errors_all, paste0(path_errors, paste0(target_park, "_errors_data_FMH.xlsx")), sheet_name = path_errors_name, overwrite_wb = TRUE)
```
