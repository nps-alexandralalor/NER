...
The Metadata file can be downloaded via the Utilities menu on the Project Management tab on the FFI Remote App Server.

-   Sample Event Report

-   Macroplot Report

The Protocol data files can be downloaded via Query tab on the FFI Remote App Server by selecting each protocol/method and exporting the file.
