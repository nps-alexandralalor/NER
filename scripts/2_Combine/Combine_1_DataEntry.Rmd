...
path_parks <- "C:/Users/alalor/OneDrive - DOI/NER/FireFX/FFI Data Management/Exports/"
parks <- list.files(path_parks)

# Load in data
target_park <- "SHEN"
path_file <- paste0(path_main, "Exports/", target_park, "/")
path_data <- paste0(path_file, "DataEntry/")
```
...
```{r}
# Load in data
Fuels1000_all <- read.csv(paste0(path_data, target_park, "_", "Surface Fuels - 1000Hr_XPT.csv"), na.strings = c("","NA","N/A"))
FuelsDuffLitt_all <- read.csv(paste0(path_data, target_park, "_", "Surface Fuels - Duff_Litter_XPT.csv"), na.strings = c("","NA","N/A"))
FuelsFine_all <- read.csv(paste0(path_data, target_park, "_", "Surface Fuels - Fine_XPT.csv"), na.strings = c("","NA","N/A"))
PostBurn_all <- read.csv(paste0(path_data, target_park, "_", "Post Burn Severity (metric)_XPT.csv"), na.strings = c("","NA","N/A"))
Trees_all <- read.csv(paste0(path_data, target_park, "_", "Trees - Individuals (metric)_XPT.csv"), na.strings = c("","NA","N/A"))
Seedlings_all <- read.csv(paste0(path_data, target_park, "_", "Density - Quadrats (metric)_XPT.csv"), na.strings = c("","NA","N/A"))
Shrubs_all <- read.csv(paste0(path_data, target_park, "_", "Density - Belts (metric)_XPT.csv"), na.strings = c("","NA","N/A"))
HerbsObs_all <- read.csv(paste0(path_data, target_park, "_", "Cover - Species Composition (metric)_XPT.csv"), na.strings = c("","NA","N/A"))
HerbsPoints_all <- read.csv(paste0(path_data, target_park, "_", "Cover - Points (metric)_XPT.csv"), na.strings = c("","NA","N/A"))
...
```{r}
# save file
write.csv(Fuels1000, paste0(path_file, target_park, "_Surface Fuels - 1000Hr.csv"), quote=FALSE, row.names = FALSE)
write.csv(FuelsDuffLitt, paste0(path_file, target_park, "_Surface Fuels - Duff_Litter.csv"), quote=FALSE, row.names = FALSE) 
write.csv(FuelsFine, paste0(path_file, target_park, "_Surface Fuels - Fine.csv"), quote=FALSE, row.names = FALSE) 
write.csv(PostBurn, paste0(path_file, target_park, "_Post Burn Severity (metric).csv"), quote=FALSE, row.names = FALSE) 
write.csv(Trees, paste0(path_file, target_park, "_Trees - Individuals (metric).csv"), quote=FALSE, row.names = FALSE) 
write.csv(Seedlings, paste0(path_file, target_park, "_Density - Quadrats (metric).csv"), quote=FALSE, row.names = FALSE) 
write.csv(Shrubs, paste0(path_file, target_park, "_Density - Belts (metric).csv"), quote=FALSE, row.names = FALSE) 
write.csv(HerbsObs, paste0(path_file, target_park, "_Cover - Species Composition (metric).csv"), quote=FALSE, row.names = FALSE) 
write.csv(HerbsPoints, paste0(path_file, target_park, "_Cover - Points (metric).csv"), quote=FALSE, row.names = FALSE) 
```
