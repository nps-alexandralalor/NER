...
qaqc <- function(data, query, query_message, values_check) {
  ...
  errors <- data %>%  
    ...
    select("SavedQuery", "SampleEvent_TreatmentUnit", "MacroPlot.Name", "Date", "Error", "Fixed", "Explanation", "Queryers")
...
path_data <- paste0(path_file, target_park, "/Data/", target_park, "_")
...
errors_blank_HerbsObs <- errors_blank %>%
