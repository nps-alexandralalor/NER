...
path_data <- paste0(path_file, target_park, "/ProjectManagement/")
...
values_valid <- c("Forest", "Grassland", "Brush", "CBI", "Control", "Inventory", "Measured", "Other", "RA")
values_check <- values_data %in% values_valid
...
write.csv(MetadataReport, paste0(path_file, target_park, "/", target_park, "_MetadataReport.csv"), quote=FALSE, row.names = FALSE, na = "") 
```
