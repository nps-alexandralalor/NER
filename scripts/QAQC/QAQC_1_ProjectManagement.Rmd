...
-   Check that Type is one of the available options ("Forest", "Grassland", "Brush", "CBI", "Control", "Inventory", "Measured", "Other", "RA", "Shrubland")
...
-   Check that UV2 = Monitoring Type
-   Check that UV3 = Vegetation Association
