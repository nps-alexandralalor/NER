...
```{r}
# Combine
errors_MacroplotReport_Setup <- unique(rbind(errors_MacroplotReport_MacroplotNum, errors_MacroplotReport_Purpose, errors_MacroplotReport_Type, errors_MacroplotReport_DateIn))
