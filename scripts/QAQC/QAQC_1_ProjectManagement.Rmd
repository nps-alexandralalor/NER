...
values_valid <- c("Fire Monitoring Handbook", "Composite Burn Index", "Rapid Assessment")
...
-   Check that Type is one of the available options
...
```{r}
errors_MacroplotReport <- rbind(errors_MacroplotReport_Installation, errors_blank_meta, errors_MacroplotReport_Location, errors_blank_meta, errors_MacroplotReport_SampleEvent)
