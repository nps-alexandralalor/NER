...
```{r}
# Blank data frame
errors_blank_species <- data.frame("SavedQuery" = "", "Error" = "", "Fixed" = "", "Explanation" = "", "Queryers" = "")
...
qaqc_species <- function(data, query, query_message, values_check) {
  ...
  errors <- data %>%  
    ...
    select("SavedQuery", "Error", "Fixed", "Explanation", "Queryers")
  
  # Next, check if there are duplicate errors
  errors_temp <- errors %>% 
    get_dupes(SavedQuery, Error)
...
-   Check that LocalSpecies_PreferedLifeForm = Graminoid, Grass-like, Forb/herb, Vine, Shrub, Subshrub, Tree, or Undefined
...
values_valid <- c("Graminoid", "Grass-like", "Forb/herb", "Vine", "Shrub", "Subshrub", "Tree", "Undefined")
...
-   Filter to exclude substrate codes. Check that MasterSpecies_ScientificName is not blank
...
query_message <- paste0("Code = ", data$LocalSpecies_Symbol, ". Scientific Name") 
...
-   Filter to exclude substrate codes. Check that MasterSpecies_ITIS_TSN is not blank
...
query_message <- paste0("Code = ", data$LocalSpecies_Symbol, ". TSN") 
...
-   Filter to exclude substrate codes. Check that MasterSpecies_Genus is not blank
...
query_message <- paste0("Code = ", data$LocalSpecies_Symbol, ". Genus") 
...
-   Filter to exclude substrate codes. Check that MasterSpecies_Family is not blank
...
query_message <- paste0("Code = ", data$LocalSpecies_Symbol, ". Family") 
...
-   Filter to exclude substrate codes. Check that MasterSpecies_NotBiological is not blank
