...
path_file <- paste0(path_main, "Exports/", target_park, "/")
path_data <- paste0(path_file, "ProjectManagement/")
...
MacroplotReport <- read.csv(paste0(path_data, target_park, "_", "MacroplotReport.csv"), na.strings = c("","NA","N/A"))
ProjectUnitReport <- read.csv(paste0(path_data, target_park, "_", "ProjectUnitAssignmentReport.csv"), na.strings = c("","NA","N/A"))
SampleEventReport <- read.csv(paste0(path_data, target_park, "_", "SampleEventReport.csv"), na.strings = c("","NA","N/A"))
```
...
[Problem:]{.underline} Macroplot Report is missing information related to plot comments
...
write.csv(MetadataReport, paste0(path_file, target_park, "_MetadataReport.csv"), quote=FALSE, row.names = FALSE) 
```
