...
errors_blank <- data.frame("SavedQuery" = "", "AdminUnit_Name" = "", "LocalSpecies_Symbol" = "", "Error" = "", "Fixed" = "", "Explanation" = "", "Queryers" = "")
...
## Load Data
SpeciesReport_all <- read.csv(paste0(path_data, "SpeciesReport.csv"))
```
...
SpeciesReport <- SpeciesReport_all %>% 
  separate(Species_AdminUnitName, sep = " ", into = c("temp", "AdminUnit_Name")) %>% 
  select(!temp) %>% 
