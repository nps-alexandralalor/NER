...
This code is intended to quality check species metadata, including the Local Species Report. This report has been cleaned and combined with other Administration Units using the Clean+Merge.Rmd script.
...
errors_group <- c("SavedQuery", "AdminUnit_Name", "LocalSpecies_Symbol", "Error")
```
...
errors_all <- condformat(errors_SpeciesReport_blanks[1:(nrow(errors_SpeciesReport_blanks)), 1:ncol(errors_all_cf)]) %>%
