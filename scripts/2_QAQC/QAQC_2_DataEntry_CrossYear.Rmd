...
This code is intended to quality check plot data across all years for protocols listed below. These protocols been cleaned using the Clean+Merge.Rmd script.
...
-   FuConSt_Count = How many unique fuel constants have been recorded for each transect?
...
```{r}
errors_Fuels_CrossYear <- rbind(errors_Fuels1000_CrossYear_Slope, errors_FuelsFine_CrossYear_Slope, errors_FuelsFine_CrossYear_Azimuth, errors_Fuels1000_CrossYear_FuConSt, errors_FuelsFine_CrossYear_FuConSt) %>% 
  arrange(Macroplot_Name, MethodData_Transect)

remove(errors_Fuels1000_CrossYear_Slope, errors_FuelsFine_CrossYear_Slope, errors_FuelsFine_CrossYear_Azimuth, errors_Fuels1000_CrossYear_FuConSt, errors_FuelsFine_CrossYear_FuConSt)
...
data <- merge(Trees_data_CrossYear, data_temp_merge_Status, all = T) %>% 
  filter(MethodData_Status == "L")
query <- "Trees Status" 
query_message <- paste0("Status = ", data$MethodData_Status, " on ", data$SampleEvent_Date, ". Death date")
