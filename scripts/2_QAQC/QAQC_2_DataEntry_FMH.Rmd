...
values_data <- data$MethodData_TranLen_ft 
values_valid <- 50  
values_check <-values_data == values_valid
...
values_data <- data$MethodData_Dia_in
values_valid <- min(3)
values_check <- values_data >= values_valid
...
#   filter(!is.na(MethodData_Dia_in))
# data_outlier <- rosnerTest(data_temp$MethodData_Dia_in)
...
data_temp <- Fuels1000_data %>%
  get_dupes(SampleEvent_Date, Macroplot_Name, MethodData_Transect, MethodData_LogNum, MethodData_Dia_in, MethodData_DecayCl)

# Set parameters 
data <- merge(Fuels1000_data, data_temp, all.x = T)
data$dupe_count[is.na(data$dupe_count)] <- 0
query <- "Fuel 1000 LogNo" 
query_message <- paste0("Log ", data$MethodData_LogNum, ". ", "Transect ", data$MethodData_Transect, ". ",  "Dia ", data$MethodData_Dia_in, ". ",  "DecayCl ", data$MethodData_DecayCl, ". ", "Duplicates")
...
values_data <- data$MethodData_Slope_pct
...
values_data <- data$MethodData_SampLoc_ft
...
query_message <- paste0("Transect = ", data$MethodData_Transect, ". ", "Sample Location = ", data$MethodData_SampLoc_ft, ". ", "Possible outlier. Litter Depth")
values_data <- data$MethodData_LittDep_in
values_valid <- 6
values_check <- values_data <= values_valid
...
# data_temp <- FuelsDuffLitt_all %>%
#   filter(!is.na(MethodData_DuffDep_in))
# data_outlier <- rosnerTest(data_temp$MethodData_DuffDep_in)
# outliers <- data_outlier$all.stats$Value[data_outlier$all.stats$Outlier]
...
query_message <- paste0("Transect = ", data$MethodData_Transect, ". ", "Sample Location = ", data$MethodData_SampLoc_ft, ". ", "Possible outlier. Duff Depth")
values_data <- data$MethodData_DuffDep_in
values_valid <- 10
values_check <- values_data <= values_valid
...
# Set parameters
data <- FuelsDuffLitt_data
data$MethodData_FuelbedDep_in[is.na(data$MethodData_FuelbedDep_in)] <- ""
query <- "Fuel DL Zero/NA"
query_message <- "FuelbedDepth"
values_data <- data$MethodData_FuelbedDep_in
values_valid <- c("", 0)
values_check <- values_data %in% values_valid
...
values_data <- data$MethodData_OneHrTranLen_ft
values_valid <- 6
values_check <- values_data == values_valid
...
values_data <- data$MethodData_TenHrTranLen_ft
values_valid <- 6
values_check <- values_data == values_valid
...
values_data <- data$MethodData_HunHrTranLen_ft
values_valid <- 12
values_check <- values_data == values_valid
...
values_data <- data$MethodData_Azimuth_deg
...
data_temp1 <- Fuels1000_data %>%
  group_by(Macroplot_Name, SampleEvent_Date, MethodData_Transect, MethodData_Slope_pct) %>%
  dplyr::summarise("Macroplot_Name" = unique(Macroplot_Name),
            "Transect" = unique(MethodData_Transect)) %>%
  mutate(Slope_1000 = MethodData_Slope_pct) %>%
  arrange(Macroplot_Name, MethodData_Transect) %>%
  select(!MethodData_Slope_pct)

data_temp2 <- FuelsFine_data %>%
  group_by(Macroplot_Name, SampleEvent_Date, MethodData_Transect, MethodData_Slope_pct) %>%
  dplyr::summarise("Macroplot_Name" = unique(Macroplot_Name),
            "Transect" = unique(MethodData_Transect)) %>%
  mutate(Slope_fine = MethodData_Slope_pct) %>%
  arrange(Macroplot_Name, MethodData_Transect) %>%
  select(!MethodData_Slope_pct)
...
values_data <- data$MethodData_TapeDist_m
values_valid <- c(1, 5, 10, 15, 20, 25, 30, 35, 40, 45)
values_check <- values_data %in% values_valid
...
values_data <- data$MethodData_MacroPlotSize_ha
values_valid <- 0.1
values_check <- values_data == values_valid
...
values_data <- data$MethodData_SnagPlotSize_ha
values_valid <- 0.1    
values_check <- values_data == values_valid
...
values_data <- data$MethodData_BrkPntDia_cm
values_valid <- 15
values_check <- values_data == values_valid
...
# Set parameters  
data <- Trees_data %>% 
  filter(is.na(MethodData_DBH_cm), MethodData_Status == "D")
...
# Set parameters 
data <- Trees_data %>% 
  filter(is.na(MethodData_DBH_cm), MethodData_Status == "L")
query <- "Trees Crown Class" 
...
# Set parameters 
data <- Trees_data %>% 
  filter(MethodData_DBH_cm > 15.0, MethodData_Status == "D")
query <- "Trees Crown Class" 
...
# Set parameters 
data <- Trees_data %>% 
  filter(MethodData_DBH_cm > 15.0, MethodData_Status == "L")
query <- "Trees Crown Class" 
...
values_data <- data$MethodData_DBH_cm
...
# # Perform Rosner's Test for outliers using all values
# data_temp <- Trees_all %>%
#   filter(!is.na(MethodData_DBH_cm))
# data_outlier <- rosnerTest(data_temp$MethodData_DBH_cm)
# outliers <- data_outlier$all.stats$Value[data_outlier$all.stats$Outlier]
...
data <- Trees_data %>% 
  filter(MethodData_CrwnCl %in% c("DD", "BBD", "CUS"))
data$MethodData_DBH_cm[is.na(data$MethodData_DBH_cm)] <- ""
query <- "Trees DD" 
...
data <- Trees_data %>% 
  filter(MethodData_CrwnCl %in% c("DD", "BBD", "CUS"))
data$MethodData_Ht_m[is.na(data$MethodData_Ht_m)] <- ""
query <- "Trees DD" 
query_message <- paste0("Tag ", data$MethodData_TagNo, ". ", "Crown Class = DD. Height")
values_data <- data$MethodData_Ht_m
values_valid <- ""
values_check <- values_data == values_valid
...
data <- Trees_data %>% 
  filter(MethodData_CrwnCl %in% c("DD", "BBD", "CUS"))
data$MethodData_LiCrBHt_m[is.na(data$MethodData_LiCrBHt_m)] <- ""
query <- "Trees DD" 
query_message <- paste0("Tag ", data$MethodData_TagNo, ". ", "Crown Class = DD. Live Crown Base Height")
values_data <- data$MethodData_LiCrBHt_m
values_valid <- ""
values_check <- values_data == values_valid
...
query_message <- paste0("Tag ", data$MethodData_TagNo, ". Species = ", data$MethodData_LocalSpeciesSymbol, ". ", "Life Form")
...
data <- Trees_data %>%
  mutate(Post = ifelse((grepl("Post|Severity", Trees_data$MonitoringStatus_Name) == TRUE), TRUE, FALSE)) %>%
  filter(Post == FALSE)
data$MethodData_ScorchHt_m[is.na(data$MethodData_ScorchHt_m)] <- ""
query <- "Trees Non-Post Severity" 
query_message <- paste0("Tag ", data$MethodData_TagNo, ". ", "Non-post read. Scorch Height")
values_data <- data$MethodData_ScorchHt_m
values_valid <- ""
values_check <- values_data == values_valid
...
data <- Trees_data %>%
  mutate(Post = ifelse((grepl("Post|Severity", Trees_data$MonitoringStatus_Name) == TRUE), TRUE, FALSE)) %>%
  filter(Post == FALSE)
data$MethodData_CrScPct_pct[is.na(data$MethodData_CrScPct_pct)] <- ""
query <- "Trees Non-Post Severity" 
query_message <- paste0("Tag ", data$MethodData_TagNo, ". ", "Non-post read. Crown Scorch Percent")
values_data <- data$MethodData_CrScPct_pct
values_valid <- ""
values_check <- values_data == values_valid
...
#          !is.na(MethodData_CharHt_m))
# data_outlier <- rosnerTest(data_temp$MethodData_CharHt_m)
# outliers <- data_outlier$all.stats$Value[data_outlier$all.stats$Outlier]
...
data <- Trees_data %>%
  ...
  filter(Post == TRUE,
         !MethodData_CrwnCl %in% c("DD", "BBD", "CUS"),
         MethodData_Status == "D",
         MethodData_ScorchHt_m != MethodData_Ht_m)
data$MethodData_ScorchHt_m[is.na(data$MethodData_ScorchHt_m)] <- ""
query <- "Trees Post Scorch"
...
# Set parameters
data <- Trees_data
data$MethodData_CrFuBHt_m[is.na(data$MethodData_CrFuBHt_m)] <- ""
query <- "Trees Zero/NA"
query_message <- "Crown Fuel Base Height"
values_data <- data$MethodData_CrFuBHt_m
values_valid <- ""
values_check <- values_data == values_valid
...
# Set parameters
data <- Trees_data
data$MethodData_CrwnRad_m[is.na(data$MethodData_CrwnRad_m)] <- ""
query <- "Trees Zero/NA"
query_message <- "Crown Radius"
values_data <- data$MethodData_CrwnRad_m
values_valid <- ""
values_check <- values_data == values_valid
...
# Set parameters
data <- Trees_data
data$MethodData_CrwnRto_pct[is.na(data$MethodData_CrwnRto_pct)] <- ""
query <- "Trees Zero/NA"
query_message <- "Crown Ratio"
values_data <- data$MethodData_CrwnRto_pct
values_valid <- ""
values_check <- values_data == values_valid
...
# Set parameters
data <- Trees_data
data$MethodData_DRC_cm[is.na(data$MethodData_DRC_cm)] <- ""
query <- "Trees Zero/NA"
query_message <- "DRC (Diameter at Root Collar)"
values_data <- data$MethodData_DRC_cm
values_valid <- ""
values_check <- values_data == values_valid
...
# Set parameters
data <- Trees_data
data$MethodData_EqDia_cm[is.na(data$MethodData_EqDia_cm)] <- ""
query <- "Trees Zero/NA"
query_message <- "Eq Diameter"
values_data <- data$MethodData_EqDia_cm
values_valid <- ""
values_check <- values_data == values_valid
...
# Set parameters
data <- Trees_data
data$MethodData_GrwthRt_cm[is.na(data$MethodData_GrwthRt_cm)] <- ""
query <- "Trees Zero/NA"
query_message <- "Growth Rate"
values_data <- data$MethodData_GrwthRt_cm
values_valid <- ""
values_check <- values_data == values_valid
...
# Set parameters
data <- Trees_data
data$MethodData_LaddBaseHt_m[is.na(data$MethodData_LaddBaseHt_m)] <- ""
query <- "Trees Zero/NA"
query_message <- "Ladder Base Height"
values_data <- data$MethodData_LaddBaseHt_m
values_valid <- ""
values_check <- values_data == values_valid
...
# Set parameters
data <- Trees_data
data$MethodData_LaddMaxHt_m[is.na(data$MethodData_LaddMaxHt_m)] <- ""
query <- "Trees Zero/NA"
query_message <- "Ladder Max Height"
values_data <- data$MethodData_LaddMaxHt_m
values_valid <- ""
values_check <- values_data == values_valid
...
# Set parameters
data <- Trees_data
data$MethodData_XCoord_m[is.na(data$MethodData_XCoord_m)] <- ""
query <- "Trees Zero/NA"
query_message <- "X Coordinate"
values_data <- data$MethodData_XCoord_m
values_valid <- ""
values_check <- values_data == values_valid
...
# Set parameters
data <- Trees_data
data$MethodData_YCoord_m[is.na(data$MethodData_YCoord_m)] <- ""
query <- "Trees Zero/NA"
query_message <- "Y Coordinate"
values_data <- data$MethodData_YCoord_m
values_valid <- ""
values_check <- values_data == values_valid
...
values_data <- data$MethodData_Area_ha
values_valid <- 50
values_check <- values_data == values_valid
...
values_data <- data$MethodData_QuadWid_m
values_valid <- 10
values_check <- values_data == values_valid
...
values_data <- data$MethodData_QuadLen_m
values_valid <- 5
values_check <- values_data == values_valid
...
query_message <- paste0("SubFrac = ", data$MethodData_SubFrac, ". ", "Species = ", data$MethodData_LocalSpeciesSymbol, ". ", "Height")
values_data <- data$MethodData_Height_m
...
query_message <- paste0("Species = ", data$MethodData_LocalSpeciesSymbol, ". ", "Life Form")
values_data <- data$Species_LifeFormNameLocal
values_valid <- "Tree"
values_check <- values_data == values_valid
...
query_message <- paste0("Species ", data$MethodData_LocalSpeciesSymbol, ". ", "Status")
values_data <- data$MethodData_Status
values_valid <- c("L")
values_check <- values_data %in% values_valid
...
values_data <- data$MethodData_TranLen_m 
values_valid <- 50  
values_check <-values_data == values_valid
...
values_data <- data$MethodData_TranWid_m
values_valid <- 2
values_check <-values_data == values_valid
...
# Set parameters
data <- Shrubs_data
data$MethodData_Height_m[is.na(data$MethodData_Height_m)] <- ""
...
data$MethodData_MinCovLevel_pct[is.na(data$MethodData_MinCovLevel_pct)] <- ""
query <- "Cvr SpComp Header" 
query_message <- "Min Cover Level"  
values_data <- data$MethodData_MinCovLevel_pct
values_valid <- ""
values_check <- values_data == values_valid
...
values_data <- data$MethodData_LocalSpeciesSymbol
...
query <- "Cvr SpComp Species"
query_message <- paste0("Species = ", data$MethodData_LocalSpeciesSymbol, ". Comment")
...
# Set parameters 
data <- HerbsPoints_data %>% 
   filter(!is.na(MethodData_Height_m))
query <- "Cvr Pts Height" 
query_message <- paste0("Transect = ", data$MethodData_Transect, ". ", "Point = ", data$MethodData_Point, ". ", "Order = ", data$MethodData_Order, ". ", "Species = ", data$MethodData_LocalSpeciesSymbol, ". ", "Height")
values_data <- data$MethodData_Height_m
values_valid <- 2
values_check <- values_data <= values_valid
...
data <- HerbsPoints_data %>% 
  filter(!is.na(MethodData_Height_m))
query <- "Cvr Pts Height" 
query_message <- paste0("Transect = ", data$MethodData_Transect, ". ", "Point = ", data$MethodData_Point, ". ", "Order = ", data$MethodData_Order, ". ", "Species = ", data$MethodData_LocalSpeciesSymbol, ". ", "Precision error. Height")
values_data <- data$MethodData_Height_m
...
data <- HerbsPoints_data %>% 
  filter(MethodData_Order == 1,
         !MethodData_LocalSpeciesSymbol %in% substrates)
data$MethodData_Height_m[is.na(data$MethodData_Height_m)] <- ""
query <- "Cvr Pts Height" 
query_message <- paste0("Transect = ", data$MethodData_Transect, ". ", "Point = ", data$MethodData_Point, ". ", "Order = ", data$MethodData_Order, ". ", "Species = ", data$MethodData_LocalSpeciesSymbol, ". ", "Height")
values_data <- data$MethodData_Height_m
...
data$MethodData_Height_m[is.na(data$MethodData_Height_m)] <- ""
query <- "Cvr Pts Height" 
query_message <- paste0("Transect = ", data$MethodData_Transect, ". ", "Point = ", data$MethodData_MethodData_MethodData_MethodData_Point, ". ", "Order = ", data$MethodData_Order, ". ", "Species = ", data$MethodData_LocalSpeciesSymbol, ". ", "Height")
values_data <- data$MethodData_Height_m
values_valid <- ""
values_check <- values_data == values_valid
...
# Set parameters 
data <- HerbsPoints_data %>% 
  filter(MethodData_LocalSpeciesSymbol %in% substrates)
data$MethodData_Height_m[is.na(data$MethodData_Height_m)] <- ""
query <- "Cvr Pts Height" 
query_message <- paste0("Transect = ", data$MethodData_Transect, ". ", "Point = ", data$MethodData_Point, ". ", "Order = ", data$MethodData_Order, ". ", "Species = ", data$MethodData_LocalSpeciesSymbol, ". ", "Height")
values_data <- data$MethodData_Height_m
...
data <- HerbsPoints_data %>% 
  filter(MethodData_LocalSpeciesSymbol %in% substrates)
query <- "Cvr Pts Order" 
query_message <- paste0("Transect = ", data$MethodData_Transect, ". ", "Point = ", data$MethodData_Point, ". ", "Species = ", data$MethodData_LocalSpeciesSymbol, ". ", "Order")
values_data <- data$MethodData_Order
values_valid <- 1
values_check <- values_data == values_valid
...
data$MethodData_Comment[is.na(data$MethodData_Comment)] <- ""
query <- "Cvr Pts Species"
query_message <- paste0("Transect = ", data$MethodData_Transect, ". ", "Point = ", data$MethodData_Point, ". ", "Species = ", data$MethodData_LocalSpeciesSymbol, ". Comment")
values_data <- data$MethodData_Comment
values_valid <- ""
values_check <- values_data == values_valid
...
query_message <- paste0("Transect = ", data$MethodData_Transect, ". ", "Point = ", data$MethodData_Point, ". ", "Order = ", data$MethodData_Order, ". ", "Species = ", data$MethodData_LocalSpeciesSymbol, ". ", "Status")
values_data <- data$MethodData_Status
values_valid <- c("L")
values_check <- values_data %in% values_valid
...
data <- HerbsPoints_data %>% 
  filter(MethodData_LocalSpeciesSymbol %in% substrates,
         !MethodData_LocalSpeciesSymbol %in% c("MOSS", "BOLE"))
query <- "Cvr Pts Status" 
query_message <- paste0("Transect = ", data$MethodData_Transect, ". ", "Point = ", data$MethodData_Point, ". ", "Order = ", data$MethodData_Order, ". ", "Species = ", data$MethodData_LocalSpeciesSymbol, ". ", "Status")
values_data <- data$MethodData_Status
values_valid <- c("D", "X")
