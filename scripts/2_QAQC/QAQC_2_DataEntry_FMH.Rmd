...
unknowns_genus <- unique(c(unknowns_SpComp_genus, unknowns_Points_genus))
...
remove(Unknowns1, Unknowns2, unknowns_SpComp_genus, unknowns_Points_genus)
...
# Set parameters 
data <- Fuels1000_data %>% 
  filter(MacroPlot.Purpose == "Inventory & Monitoring")
query <- "Fuel 1000 Header"
query_message <- "Number of Transects" 
values_data <- data$NumTran
values_valid <- 1
