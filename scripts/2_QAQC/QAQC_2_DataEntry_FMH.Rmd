...
# Edit blank data frame as preferred error log template.
errors_blank <- data.frame("SavedQuery" = "", "AdminUnit_Name" = "", "SampleEvent_TreatmentUnit" = "", "Macroplot_Name" = "", "SampleEvent_Date" = "", "Error" = "", "Fixed" = "", "Explanation" = "", "Queryers" = "") %>%
