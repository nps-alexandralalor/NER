...
data_temp <- Fuels1000_data %>%
  get_dupes(SampleEvent_Date, Macroplot_Name, Transect, LogNum, Dia, DecayCl)
...
# Set parameters
data <- merge(FuelsFine_data, data_temp, by = c("Macroplot_Name", "SampleEvent_Date", "Transect"), all = T)
query <- "Fuel Fine Slope"
