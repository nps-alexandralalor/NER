...
source("C:/Users/allie/OneDrive/Desktop/R Projects/NER/scripts/2_QAQC/qaqc_function.R")
```
...
path_data <- paste0(path_main, "R Outputs/NER/")
...
errors_all <- condformat(errors_all_cf[1:(nrow(errors_all_cf)), 1:10]) %>%
  rule_fill_discrete(columns = 1:9,
