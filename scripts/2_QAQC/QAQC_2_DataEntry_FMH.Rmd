...
query_message <- paste0("Tag ", data$MethodData_TagNo, ". Species = ", data$Species_SymbolLocal, ". ", "Life Form")
...
query_message <- paste0("SubFrac = ", data$MethodData_SubFrac, ". ", "Species = ", data$Species_SymbolLocal, ". ", "Height")
...
query_message <- paste0("Species = ", data$Species_SymbolLocal, ". ", "Life Form")
values_data <- data$Species_LifeFormNameLocal
values_valid <- "Tree"
values_check <- values_data == values_valid
...
query_message <- paste0("Species ", data$Species_SymbolLocal, ". ", "Status")
values_data <- data$MethodData_Status
values_valid <- c("L")
values_check <- values_data %in% values_valid
...
values_data <- data$Species_SymbolLocal
...
query <- "Cvr SpComp Species"
query_message <- paste0("Species = ", data$Species_SymbolLocal, ". Comment")
...
query_message <- paste0("Transect = ", data$MethodData_Transect, ". ", "Point = ", data$MethodData_Point, ". ", "Order = ", data$MethodData_Order, ". ", "Species = ", data$Species_SymbolLocal, ". ", "Height")
values_data <- data$MethodData_Height
values_valid <- 2
values_check <- values_data <= values_valid
...
data <- HerbsPoints_data %>% 
  filter(!is.na(MethodData_Height))
query <- "Cvr Pts Height" 
query_message <- paste0("Transect = ", data$MethodData_Transect, ". ", "Point = ", data$MethodData_Point, ". ", "Order = ", data$MethodData_Order, ". ", "Species = ", data$Species_SymbolLocal, ". ", "Precision error. Height")
values_data <- data$MethodData_Height
...
data <- HerbsPoints_data %>% 
  filter(MethodData_Order == 1,
         !Species_SymbolLocal %in% substrates)
data$MethodData_Height[is.na(data$MethodData_Height)] <- ""
query <- "Cvr Pts Height" 
query_message <- paste0("Transect = ", data$MethodData_Transect, ". ", "Point = ", data$MethodData_Point, ". ", "Order = ", data$MethodData_Order, ". ", "Species = ", data$Species_SymbolLocal, ". ", "Height")
values_data <- data$MethodData_Height
...
data$MethodData_Height[is.na(data$MethodData_Height)] <- ""
query <- "Cvr Pts Height" 
query_message <- paste0("Transect = ", data$MethodData_Transect, ". ", "Point = ", data$MethodData_MethodData_MethodData_MethodData_Point, ". ", "Order = ", data$MethodData_Order, ". ", "Species = ", data$Species_SymbolLocal, ". ", "Height")
values_data <- data$MethodData_Height
values_valid <- ""
values_check <- values_data == values_valid
...
# Set parameters 
data <- HerbsPoints_data %>% 
  filter(Species_SymbolLocal %in% substrates)
data$MethodData_Height[is.na(data$MethodData_Height)] <- ""
query <- "Cvr Pts Height" 
query_message <- paste0("Transect = ", data$MethodData_Transect, ". ", "Point = ", data$MethodData_Point, ". ", "Order = ", data$MethodData_Order, ". ", "Species = ", data$Species_SymbolLocal, ". ", "Height")
values_data <- data$MethodData_Height
...
data <- HerbsPoints_data %>% 
  filter(Species_SymbolLocal %in% substrates)
query <- "Cvr Pts Order" 
query_message <- paste0("Transect = ", data$MethodData_Transect, ". ", "Point = ", data$MethodData_Point, ". ", "Species = ", data$Species_SymbolLocal, ". ", "Order")
values_data <- data$MethodData_Order
values_valid <- 1
values_check <- values_data == values_valid
...
data$MethodData_Comment[is.na(data$MethodData_Comment)] <- ""
query <- "Cvr Pts Species"
query_message <- paste0("Transect = ", data$MethodData_Transect, ". ", "Point = ", data$MethodData_Point, ". ", "Species = ", data$Species_SymbolLocal, ". Comment")
values_data <- data$MethodData_Comment
values_valid <- ""
values_check <- values_data == values_valid
...
query_message <- paste0("Transect = ", data$MethodData_Transect, ". ", "Point = ", data$MethodData_Point, ". ", "Order = ", data$MethodData_Order, ". ", "Species = ", data$Species_SymbolLocal, ". ", "Status")
values_data <- data$MethodData_Status
values_valid <- c("L")
values_check <- values_data %in% values_valid
...
data <- HerbsPoints_data %>% 
  filter(Species_SymbolLocal %in% substrates,
         !Species_SymbolLocal %in% c("MOSS", "BOLE"))
query <- "Cvr Pts Status" 
query_message <- paste0("Transect = ", data$MethodData_Transect, ". ", "Point = ", data$MethodData_Point, ". ", "Order = ", data$MethodData_Order, ". ", "Species = ", data$Species_SymbolLocal, ". ", "Status")
values_data <- data$MethodData_Status
values_valid <- c("D", "X")
