...
program_summ <- MetadataReport_filter %>%
...
target_park_summ <- MetadataReport_filter %>%
...
protocol_use_summ <- MetadataReport_filter %>%
  filter(Protocols != "") %>% 
...
target_project_summ <- MetadataReport_all %>%
...
target_year_summ <- MetadataReport_all %>%
