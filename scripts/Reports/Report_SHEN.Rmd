...
HerbsObs <- read.csv(paste0(path_data, "Data_Cover - Species Composition (metric).csv"))
HerbsPoints <- read.csv(paste0(path_data, "Data_Cover - Points (metric).csv"))

MetadataReport2 <- read.csv(paste0(path_data, "MetadataReport.csv"), quote = "")
Fuels1000 <- read.csv(paste0(path_data, "Data_Surface Fuels - 1000Hr.csv"), quote = "")
FuelsDuffLitt2 <- read.csv(paste0(path_data, "Data_Surface Fuels - Duff_Litter.csv"), quote = "")
FuelsFine2 <- read.csv(paste0(path_data, "Data_Surface Fuels - Fine.csv"), quote = "")
PostBurn2 <- read.csv(paste0(path_data, "Data_Post Burn Severity (metric).csv"), quote = "")
Trees2 <- read.csv(paste0(path_data, "Data_Trees - Individuals (metric).csv"), quote = "")
Seedlings2 <- read.csv(paste0(path_data, "Data_Density - Quadrats (metric).csv"), quote = "")
Shrubs2 <- read.csv(paste0(path_data, "Data_Density - Belts (metric).csv"), quote = "")
HerbsObs2 <- read.csv(paste0(path_data, "Data_Cover - Species Composition (metric).csv"), quote = "")
HerbsPoints2 <- read.csv(paste0(path_data, "Data_Cover - Points (metric).csv"), quote = "")
```
