...
for(i in parks) {
  ...
  MacroplotReport_SampleEvents <- MacroplotReport %>%
    ...
    # remove unnecessary columns
    select(!c(SampleEvent_Time, MonitoringStatus_Name)) %>%
  ...
  MetadataReport <- merge(MacroplotReport_merge, SampleEventReport_merge, by = c("Macroplot_Name", "SampleEvent_Date", "SampleEvent_Date_Year")) %>%
