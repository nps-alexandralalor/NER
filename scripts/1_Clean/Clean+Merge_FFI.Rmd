...
for(i in parks) {
  ...
  MetadataReport <- merge(MacroplotReport_merge, SampleEventReport_merge, by = c("Macroplot_Name", "SampleEvent_Date")) %>%
    relocate(AdminUnit_Name, .before = Purpose) %>%
    relocate(Type, .after = Purpose) %>% 
    relocate(ProjectUnit_Name, .after = Type) %>%
    relocate(Macroplot_Name, .after = ProjectUnit_Name) %>%
  ...
  # final column renaming to match protocol exports
    final_df <- final_df %>% 
      dplyr::rename(
        ...
        #Species_SymbolMaster = # not on species report
...
# final column renaming to match metadata
  final_df <- final_df %>%  
    dplyr::rename(
      ...
      MethodData_Index = Index,
      MethodData_Transect = Transect,
      MethodData_SampLoc = SampLoc,
      MethodData_OffSet = OffSet,
      MethodData_LittDep = LittDep,
      MethodData_DuffDep = DuffDep,
      MethodData_FuelbedDep = FuelbedDep,
...
# final column renaming to match metadata
  final_df <- final_df %>%  
    dplyr::rename(
      ...
      MonitoringStatus_Order = Status.Order,
      MethodData_NumTran = NumTran,
      MethodData_OneHrTranLen = OneHrTranLen,
      MethodData_TenHrTranLen = TenHrTranLen,
      MethodData_HunHrTranLen = HunHrTranLen,
      MethodData_FieldTeam = FieldTeam,
      MethodData_EntryTeam = EntryTeam,
      MethodData_UV1Desc = UV1Desc,
      MethodData_UV2Desc = UV2Desc,
...
# final column renaming to match metadata
  final_df <- final_df %>%  
    dplyr::rename(
      ...
      Species_Invasive = Invasive.Species,
      Species_SymbolLocal = Species.Symbol,
      MethodData_MacroPlotSize = MacroPlotSize,
      MethodData_SnagPlotSize = SnagPlotSize,
      MethodData_BrkPntDia = BrkPntDia,
      MethodData_FieldTeam = FieldTeam,
      MethodData_EntryTeam = EntryTeam,
      MethodData_UV1Desc = UV1Desc,
      MethodData_UV2Desc = UV2Desc,
      ...
      MethodData_LiCrBHt = LiCrBHt,
      MethodData_CrFuBHt = CrFuBHt,
      MethodData_CrwnRad = CrwnRad,
      MethodData_Age = Age,
      MethodData_GrwthRt = GrwthRt,
      MethodData_Mort = Mort,
      MethodData_DecayCl = DecayCl,
      MethodData_LaddBaseHt = LaddBaseHt,
      MethodData_LaddMaxHt = LaddMaxHt,
      MethodData_DRC = DRC,
      MethodData_NuLiStems = NuLiStems,
      MethodData_NuDeStems = NuDeStems,
      MethodData_EqDia = EqDia,
      MethodData_XCoord = XCoord,
      MethodData_YCoord = YCoord,
      MethodData_CKR = CKR,
      MethodData_CharHt = CharHt,
      MethodData_ScorchHt = ScorchHt,
