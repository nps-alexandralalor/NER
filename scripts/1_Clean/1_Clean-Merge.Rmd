...
path_save <- paste0(path_main, "R Outputs/NER/")
```
...
for(i in parks) {
  ...
  Fuels1000 <- Fuels1000 %>% 
    dplyr::rename(
      ...
      #MethodData_uV2 = UV2,
      #MethodData_uV3 = UV3,
      #MethodData_createdDate = # not in FFI
      #MethodData_updatedDate = # not in FFI
      #MethodData_deletedDate = # not in FFI
      )
...
for(i in parks) {
  ...
  Trees <- Trees %>% 
    dplyr::rename(
      ...
      #MethodData_uV2 = UV2,
      #MethodData_uV3 = UV3,
      #MethodData_density = # not in FFI
      #MethodData_basalArea = # not in FFI
      #MethodData_createdDate = # not in FFI
      #MethodData_updatedDate = # not in FFI
      #MethodData_deletedDate = # not in FFI
      )
