...
for(i in parks) {
  ...
  # final column renaming to match protocol exports
    MetadataReport <- MetadataReport %>% 
      dplyr::rename(
        #AdminUnit_Name = AdministrationUnit_Name,
        #ProjectUnit_Name = ProjectUnit,
        #Macroplot_Purpose = Purpose,
        #Macroplot_Type = Type,
        #Macroplot_Name = Macroplot,
        ...
        #Macroplot_DateIn = DateIn,
        #Macroplot_DateIn_Year = DateIn_Year,
        #Macroplot_FutureVisit = FutureVisit,
        #Macroplot_FutureVisit_Year = FutureVisit_Year,
        #Macroplot_DateOut = DateOut,
        #Macroplot_DateOut_Year = DateOut_Year,
        ...
        Macroplot_UV7 = UV7,
        Macroplot_UV8 = UV8
        #SampleEvent_Date = SampleEventDate,
        #SampleEvent_Date_Year = SampleEventDate_Year,
        #SampleEvent_Who = SampleEventTeam,
        #SampleEvent_Comment = SampleEventComment,
        #SampleEvent_DefaultMonitoringStatus =  # What is this?
        #SampleEvent_TreatmentUnit =  # What is this?
        #LegacyMonStatus = LegacyMonStatus, # Does this have equivalent?
        #MonitoringStatus_Name = MonStatus, # ?
        #Protocols = Protocols, # Not in Project Unit data depot report
        #Visited = Visited # MethodData_Visited?
        )
