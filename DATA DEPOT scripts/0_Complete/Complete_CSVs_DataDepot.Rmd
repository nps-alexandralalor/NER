...
path_zip <- paste0(path_main, "Exports Data Depot/", target_park, "/")
path_data_english <- paste0(path_zip, "English_ffi_", target_park, "_data_export_1769085509810/")
path_data_metric <- paste0(path_zip, "Metric_ffi_", target_park, "_data_export_1769085510263/")

path_data_original <- paste0("E:/Allie/FireFX_NER/FFI Data Management/R Outputs/", target_park, "/", target_park, "_")
...
# project unit report
ProjectUnitReport <- read_csv(paste0(path_data_english, "ffi_", target_park, "_data_export_project_units.csv"))

# protocols
O_Fuels1000 <- read_csv(paste0(path_data_original, "Data_Surface Fuels - 1000Hr.csv"))
O_FuelsDuffLitt <- read_csv(paste0(path_data_original, "Data_Surface Fuels - Duff_Litter.csv"))
O_FuelsFine <- read_csv(paste0(path_data_original, "Data_Surface Fuels - Fine.csv"))
O_Trees <- read_csv(paste0(path_data_original, "Data_Trees - Individuals (metric).csv"))
O_HerbsSpComp <- read_csv(paste0(path_data_original, "Data_Cover - Species Composition (metric).csv"))
O_HerbsPoints <- read_csv(paste0(path_data_original, "Data_Cover - Points (metric).csv"))
# protocols
E_Fuels1000 <- read_csv(paste0(path_data_english, "ffi_", target_park, "_data_export_surface_fuels_thousand_hr.csv"))
E_FuelsDuffLitt <- read_csv(paste0(path_data_english, "ffi_", target_park, "_data_export_surface_fuels_duff_litter.csv"))
E_FuelsFine <- read_csv(paste0(path_data_english, "ffi_", target_park, "_data_export_surface_fuels_fine.csv"))
E_Trees <- read_csv(paste0(path_data_english, "ffi_", target_park, "_data_export_trees_individuals.csv"))
E_HerbsSpComp <- read_csv(paste0(path_data_english, "ffi_", target_park, "_data_export_cover_species_composition.csv"))
E_HerbsPoints <- read_csv(paste0(path_data_english, "ffi_", target_park, "_data_export_cover_points.csv"))
# protocols
M_Fuels1000 <- read_csv(paste0(path_data_metric, "ffi_", target_park, "_data_export_surface_fuels_thousand_hr.csv"))
M_FuelsDuffLitt <- read_csv(paste0(path_data_metric, "ffi_", target_park, "_data_export_surface_fuels_duff_litter.csv"))
M_FuelsFine <- read_csv(paste0(path_data_metric, "ffi_", target_park, "_data_export_surface_fuels_fine.csv"))
M_Trees <- read_csv(paste0(path_data_metric, "ffi_", target_park, "_data_export_trees_individuals.csv"))
M_HerbsSpComp <- read_csv(paste0(path_data_metric, "ffi_", target_park, "_data_export_cover_species_composition.csv"))
M_HerbsPoints <- read_csv(paste0(path_data_metric, "ffi_", target_park, "_data_export_cover_points.csv"))


# # blank protocols
# E_FuelsDuffLittAK <- read_csv(paste0(path_data_english, "ffi_", target_park, "_data_export_surface_fuels_alaska_duff_litter.csv"))
# E_FuelsPiles <- read_csv(paste0(path_data_english, "ffi_", target_park, "_data_export_surface_fuels_piles.csv"))
# E_FuelsVeg <- read_csv(paste0(path_data_english, "ffi_", target_park, "_data_export_surface_fuels_vegetation.csv"))
# E_TreesSaplings <- read_csv(paste0(path_data_english, "ffi_", target_park, "_data_export_trees_saplings.csv"))
# E_TreesSeedlings <- read_csv(paste0(path_data_english, "ffi_", target_park, "_data_export_trees_seedlings.csv"))
# E_HerbsFrequency <- read_csv(paste0(path_data_english, "ffi_", target_park, "_data_export_cover_frequency.csv"))
# # blank protocols
# M_FuelsDuffLittAK <- read_csv(paste0(path_data_metric, "ffi_", target_park, "_data_export_surface_fuels_alaska_duff_litter.csv"))
# M_FuelsPiles <- read_csv(paste0(path_data_metric, "ffi_", target_park, "_data_export_surface_fuels_piles.csv"))
# M_FuelsVeg <- read_csv(paste0(path_data_metric, "ffi_", target_park, "_data_export_surface_fuels_vegetation.csv"))
# M_TreesSaplings <- read_csv(paste0(path_data_metric, "ffi_", target_park, "_data_export_trees_saplings.csv"))
# M_TreesSeedlings <- read_csv(paste0(path_data_metric, "ffi_", target_park, "_data_export_trees_seedlings.csv"))
# M_HerbsFrequency <- read_csv(paste0(path_data_metric, "ffi_", target_park, "_data_export_cover_frequency.csv"))
```
...
# Set parameters 
data <- Fuels1000 %>% 
  mutate(Quotes = pmap_lgl(as.list(Fuels1000), 
    ~ any(str_detect(c(...), '[�]]')))) %>% 
  mutate(Quotes = ifelse(is.na(Quotes), FALSE, Quotes))
query <- "Fuel 1000"
query_message <- "Quotes"
...
# Set parameters 
data <- Fuels1000 %>% 
  mutate(Commas = pmap_lgl(as.list(Fuels1000), 
    ~ any(str_detect(c(...), '[,]')))) %>% 
  mutate(Commas = ifelse(is.na(Commas), FALSE, Commas))
query <- "Fuel 1000"
query_message <- "Commas"
